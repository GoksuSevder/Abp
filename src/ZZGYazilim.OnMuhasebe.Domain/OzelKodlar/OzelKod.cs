namespace ZZGYazilim.OnMuhasebe.OzelKodlar;
public class OzelKod : FullAuditedAggregateRoot<Guid>
{
    ...
    public ICollection<BankaSube> OzelKod1BankaSubelar { get; set; }
    public ICollection<BankaSube> OzelKod2BankaSubelar { get; set; }
    ...
    public ICollection<Sube> OzelKod1Subeler { get; set; }
    public ICollection<Sube> OzelKod2Subeler { get; set; }
