...
public class OnMuhasebeBlazorModule : AbpModule
{
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles("/ZZGYazilim.OnMuhasebe.Blazor.styles.css");
                }
            );
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<OnMuhasebeDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}ZZGYazilim.OnMuhasebe.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<OnMuhasebeDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}ZZGYazilim.OnMuhasebe.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<OnMuhasebeApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}ZZGYazilim.OnMuhasebe.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<OnMuhasebeApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}ZZGYazilim.OnMuhasebe.Application"));
